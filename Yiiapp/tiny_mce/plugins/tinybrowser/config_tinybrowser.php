...
$tinybrowser['obfuscate'] = 'vdhfkslfjd89yG87t78sgrw3rh98uZyTO7sd@4';
...
$tinybrowser['docroot'] = str_replace($_SERVER['PHP_SELF'],'',$_SERVER['SCRIPT_FILENAME']).'/uploads/tiny_mce';

//echo($tinybrowser['docroot']);
...
$tinybrowser['link']['image'] = 'http://'.$_SERVER['HTTP_HOST'].'/uploads/tiny_mce'.$tinybrowser['path']['image']; // Image links
$tinybrowser['link']['media'] = 'http://'.$_SERVER['HTTP_HOST'].'/uploads/tiny_mce'.$tinybrowser['path']['media']; // Media links
$tinybrowser['link']['file']  = 'http://'.$_SERVER['HTTP_HOST'].'/uploads/tiny_mce'.$tinybrowser['path']['file']; // Other file links
...
$tinybrowser['imageresize']['width']  = 950;
