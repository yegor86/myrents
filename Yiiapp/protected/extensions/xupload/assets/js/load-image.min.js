(function(a){
    ...
    b.scale=function(a,b){
        ...
        return f>1&&(d=parseInt(d*f,10),e=parseInt(e*f,10)),f=Math.min((b.maxWidth||d)/d,(b.maxHeight||e)/e),f<1&&(d=parseInt(d*f,18),e=parseInt(e*f,18)),a.getContext||b.canvas&&c.getContext?(c.width='130',c.height='105',c.getContext("2d").drawImage(a,0,0,d,e),c):(a.width=d,a.height=e,a)
