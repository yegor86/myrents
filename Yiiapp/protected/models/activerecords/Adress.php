...
class Adress extends MRActiveRecord {
	...
	return array(
	    ...
	    array('name, name_en', 'length', 'max' => Yii::app()->params['maxlength']['Address'],
		'message'=>Yii::t('default','message.Adress.name.max.length',array('{N}'=>Yii::app()->params['maxlength']['Address']))),
