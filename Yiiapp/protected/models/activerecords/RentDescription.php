...
class RentDescription extends MRActiveRecord {
	...
	return array(
	    ...
	    array('name', 'length', 'max' => Yii::app()->params['maxlength']['RentEditName'],
		'message'=>Yii::t('default', 'message.RentDescription.name.maxlength',array('{N}'=>Yii::app()->params['maxlength']['RentEditName'])) ),
	    array('overview', 'length', 'max' => Yii::app()->params['maxlength']['RentEditOverview'],
		'message'=>Yii::t('default', 'message.RentDescription.overview.maxlength',array('{N}'=>Yii::app()->params['maxlength']['RentEditOverview'])) ),
	    array('rules', 'length', 'max' => Yii::app()->params['maxlength']['RentEditRules'],
		'message'=>Yii::t('default', 'message.RentDescription.rules.maxlength',array('{N}'=>Yii::app()->params['maxlength']['RentEditRules'])) ),
