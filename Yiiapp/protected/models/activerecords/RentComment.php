	...
	public function rules()
	{
		...
		return array(
			...
			array('sender_id, receiver_id, in_show', 'numerical', 'integerOnly'=>true),
		                  array('message', 'length', 'max'=>Yii::app()->params['maxlength']['RentComment'],
			     'message'=>Yii::t('default','message.RentComment.length.max',array('{N}'=>Yii::app()->params['maxlength']['RentComment']))),
