...
class SearchForm extends CFormModel {
	...
	return array(
	    ...
	    array('searchString', 'length', 'max' => Yii::app()->params['maxlength']['SearchString'],  
		'message' => Yii::t('default','message.SearchForm.searchstring.max',array('{N}'=>Yii::app()->params['maxlength']['SearchString']))),
