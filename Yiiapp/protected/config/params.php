 ...
 */
return array(
    'sitemap_max_links'=>5000, //SEO максимальное количество ссылок в одном файле sitemap, ограничено 50к,
			//но при 50к едостаёт памяти, по-этому поставил ограничение в 5к
    'SEOStaticSitemapLinks'=>  require(dirname(__FILE__) . '/sitemap_static_links.php'),//файл сл списком статичных ссылок сайтмап
...
//переменные для сео-страниц
    ...
    'logdir' => '/log/',
    'CityesUrl' => require_once (dirname(__FILE__) . '/CityesList.php'),
    'TodoUrl' => array(
	'rent' => 1,
	'sale' => 2
    ),
...
//  'yandexKey'=>'AA-PyE8BAAAACrsIDwMA9uvpCsK0u0PsIzx-etx3HjB4WloAAAAAAAAAAABDhRBH0fBGvXJqUiElyZrCPLZaSA=='
    ...
    'smsTopPeriods'=>array(
	'8313'=>array('name'=>'top.per.day','price'=>'5.00 грн.','periodInDays'=>3),
	'576'=>array('name'=>'top.per.three.day','number'=>'333','price'=>'10.00 грн.','periodInDays'=>7),
	'3161'=>array('name'=>'top.per.seven.day','number'=>'777','price'=>'15.00 грн.','periodInDays'=>14),
	),
   'smsMainPeriods'=>array(
	//'4540'=>array('name'=>'main.per.day','price'=>'5.00 грн.','periodInDays'=>3),
	'5060'=>array('name'=>'main.per.three.day','number'=>'333','price'=>'30.00 грн.','periodInDays'=>7),
	//'4449'=>array('name'=>'main.per.seven.day','number'=>'777','price'=>'16.00 грн.','periodInDays'=>14),
        ),
    'mailerSecret'=>'ZCnkNtWtWlMko',
    ...
    //список контроллеров, обращения к которым будет схранено для редиректа
    'controllersToRedirect'=>array(
	'help','members','messages','news','partners','presetSearch','rent','rentCreate','rentEdit','rentEditNeiborhood',
	'rentEditPhotos','rentEditPlace','rentEditTerms','rules','search','staticPage','support','test','up','user','userEdit'
    ),
    
    'maxlength' =>require_once (dirname(__FILE__) . '/maxlength_text.php'),
    )
