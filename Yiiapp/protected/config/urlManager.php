...
/*	'members/agency' => 'members/agency',
	'members/agency/<lang:([a-zA-Z]{2})?>' => 'members/agency',
	'members/agency/<page:([\d]+)>' => 'members/agency',
	'members/agency/<page:([\d]+)>/<lang:([a-zA-Z]{2})?>' => 'members/agency',
*/
 	'members' => 'members/users',
 	'members/<page:([\d]+)>' => 'members/users',
	'members/<lang:([a-zA-Z]{2})?>' => 'members/users',
	'members/<page:([\d]+)>/<lang:([a-zA-Z]{2})?>' => 'members/users',
	'members/<usertype:(users|realtors|private|agency)>' => 'members/users',
	'members/<usertype:(users|realtors|private|agency)>/<page:([\d]+)>' => 'members/users',
	'members/<usertype:(users|realtors|private|agency)>/<lang:([a-zA-Z]{2})?>' => 'members/users',
	'members/<usertype:(users|realtors|private|agency)>/<page:([\d]+)>/<lang:([a-zA-Z]{2})?>' => 'members/users',
	...
	'/messages/send/<receiver_id:\d+>' => 'messages/send',
	'/messages/send/<receiver_id:\d+>/<lang:([a-zA-Z]{2})?>' => 'messages/send',
	...
	'user/<id:\d+>/<lang:([a-zA-Z]{2})?>' => 'user/hostings',
	'user/<id:\d+>' => 'user/hostings',
	...
	'agency/<id:(\d+)>/edit'=>'agencyEdit/edit',
	'agency/<id:(\d+)>/edit/<lang:([a-zA-Z]{2})?>'=>'agencyEdit/edit',
	
	'agency'=>'agency/index',
	'agency/<lang:([a-zA-Z]{2})?>'=>'agency/index',
	'agency/new'=>'agency/createAgency',
	'agency/new/<lang:([a-zA-Z]{2})?>'=>'agency/create',

	'agency/<id:(\d+)>'=>'agency/index',
	'agency/<id:(\d+)>/<lang:([a-zA-Z]{2})?>'=>'agency/index',
	...
	'admin/user/emailList' => 'adminUsers/adminUsersEmailList',
        'admin/user/emailList/<show:(all)>' => 'adminUsers/adminUsersEmailList',
	...
	'admin/mailer' => 'adminMailer/mailer',
