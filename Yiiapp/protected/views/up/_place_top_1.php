...
<div id="ajax_popup">
<div class="popup_head"><?php if(isset($_POST['global'])){?><div class="goback"></div><?php }?><h2><?php echo Yii::t('default','sms.popup.window.text.header_top')?></h2></div>
<div id="popup_container" style="width:430px;padding:20px 60px 20px 60px;height: 460px">
    <span style="line-height: 18px;"><?php echo Yii::t('default','sms.popup.window.text.top')?></span>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td valign="top"><small><?php echo Yii::t('default','sms.popup.window.text.send_code')?>:</small><span class="numerical" ><?php echo Yii::app()->params['smsbillmainprefix'].Yii::app()->params['smsbillMRprefix'].'+<span id="id_board"></span>'.Yii::app()->params['billingActions'][0].''  ;?></span></td>
