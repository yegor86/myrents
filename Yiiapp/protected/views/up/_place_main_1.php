...
<div id="popup_container" style="width:430px;padding:20px 60px 20px 60px;height: 420px">
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td valign="top"><small><?php echo Yii::t('default','sms.popup.window.text.send_code')?>:</small><span class="numerical" ><?php echo Yii::app()->params['smsbillmainprefix'].Yii::app()->params['smsbillMRprefix'].'+<span id="id_board"></span>'.Yii::app()->params['billingActions'][1].''  ;?></span></td>
