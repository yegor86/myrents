...
<div class="pdd_20">
<?php
echo CHtml::link('<span><b><i>' . Yii::t('default','&nbsp;&nbsp;&nbsp;Drop&nbsp;&nbsp;&nbsp;') . '</i></b></span>', 'javascript:void(0)', array('onclick' => 'mr_dialog_del_rent(\''.Yii::t('default','dialog.delete.title').'\', \''.Yii::t('default','dialog.yes').'\', \''.Yii::t('default','dialog.no').'\');', 'class' => ' abutton blue'));
?>
</div>
</div>
