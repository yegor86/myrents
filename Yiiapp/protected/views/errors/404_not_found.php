...
$this->pageTitle = Yii::t('default','page.not.found');
...
<div class="main one">
	...
	<div>
	    <div>
		<div></div>
		<table border="0" cellpadding="0" cellspacing="0" width="99%"><tr><td valign="middle"><?php echo Yii::t('default','page.not.found.title'); ?>
    ...
    <div class="content">
        <div class="no_public" style="margin:60px 0 40px;"><div style="">
            <div class="stl_2" style="width:550px;"><?php echo Yii::t('default','page.not.found.text_1'); ?></div>
            <br><br><br>
