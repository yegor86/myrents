<div class="popup_head"><h2><?php echo Yii::t('default', 'need.help') ?></h2></div>
...
<?php 
    echo CHtml::link('<span><b><i>'.Yii::t('default','send').'</i></b></span>','javascript:void(0)',array('onclick'=>'ajaxSubmitForm("#supportForm","/support","#popup_container")','class'=>'btn_border abutton yellow'));
    ?>
