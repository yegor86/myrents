...
<?php if (count($rent->photos) == true) { ?>
	...
	<?php $img = CHtml::image('/uploads/rentpic/' 
                                . Yii::app()->putils->fragment($rent->id)
                                . '/thumbs/' 
                                . $photo->file); ?>
						<li><?php echo CHtml::link($img, '/uploads/rentpic/' 
                                . Yii::app()->putils->fragment($rent->id)
                                . '/' 
                                . $photo->file); ?></li>
    <?php } ?>
...
<?php } ?>
			    ...
			    <td valign="bottom"><a class="btn_border abutton yellow" href="/messages/send/<?php echo $rent['renter']['id']?>" ><span><b><i><?php echo Yii::t('default', 'Send message') ?></i></b></span></a>
			    </td>
			</tr>
		    </table>
		</div>
...
<?php if (count($similarRents)) { ?>
    		...
    		<div class="scroll-pane">
				...
				<div class="flt_l clr">
				    <?php echo '<a href="/rent/' 
                            . $similarRent['rent']->id 
                            . '"><span class="similar_img" style="background-image: url(\'/uploads/rentpic/'
                            . Yii::app()->putils->fragment($similarRent['rent']->id)
                            . '/thumbs/' 
                            . $similarRent['rent']->photos[0]->file 
                            . '\')"></span></a>'; ?>
