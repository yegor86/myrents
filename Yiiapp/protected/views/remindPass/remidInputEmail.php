...
<div id="support_box_popup" style="border:0;margin-left: 100px;margin-right: 100px;">
 ...
 <?php
    ...
    <br/>
    <div style="line-height: 20px"><?php echo Yii::t('default','remind.page.info.text')?></div>
