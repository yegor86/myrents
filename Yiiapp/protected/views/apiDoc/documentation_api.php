        ...
        <div class="tab_content pdd_10">
            ...
            <table border="0" width="100%" cellpadding="1" cellspacing="1" class="sort">
              ...
              <tr>
                ...
                <td width="85%">(числовое значение)</td>
              </tr>
              <tr>
    ...
    &lt;/advertisements&gt;
          ...
          <h2>Основная информация объявления &lt;maininfo&gt;</h2>
            <table border="0" width="100%" cellpadding="1" cellspacing="1" class="sort">
                ...
                <tr>
                    <td width="15%"><b>creation_date</b></td>
                    <td width="85%"><b>Дата создание:</b><br>формат: YYYY-mm-dd H:i:s</td>
                </tr>
                <tr>
                    <td width="15%"><b>visible</b></td>
                    <td width="85%"><b>Показать/Скрыть:</b><br>1 - показывается, 0 - скрыто (числовое значение)</td>
                </tr>
            </table>
    <br><br>
            <b>Пример</b>
...
&lt;maininfo&gt;
    ...
    &lt;floor&gt;8&lt;/floor&gt;
    &lt;rooms&gt;3&lt;/rooms&gt;
    &lt;creation_date&gt;2012-05-31 12:00:11&lt;/creation_date&gt;
    &lt;visible&gt;1&lt;/visible&gt;
&lt;/maininfo&gt;
</pre>
<br/><br/>
