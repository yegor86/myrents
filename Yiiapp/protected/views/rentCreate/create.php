...
<div> <?php echo $form->error($model,'['.$key.']overview'); ?>
    <?php echo $form->textArea($model,'['.$key.']overview',array('class'=>'f_form nametextarea','rows'=>'15','cols'=>'20','maxlength'=>Yii::app()->params['maxlength']['RentEditOverview'], 'id'=>'f_counter_1')); ?><div class="hint"><?php echo Yii::t('default','bill overview example')?>
</div>
</div>
<div class="stl_2"><?php echo Yii::t('default','bill rules') ?>:</div>
<div> <?php echo $form->error($model,'['.$key.']rules'); ?>
    <?php echo $form->textArea($model,'['.$key.']rules',array('class'=>'f_form nametextarea_rules','rows'=>'7','cols'=>'20','maxlength'=>Yii::app()->params['maxlength']['RentEditRules'], 'id'=>'f_counter_2')); ?>
...
$(document).ready(function($){
    ...
    $(".nametextarea_rules").charCount({allowed: <?php echo Yii::app()->params['maxlength']['RentEditRules']?>, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
    $(".nameinput").charCount({allowed: <?php echo Yii::app()->params['maxlength']['RentEditName']?>, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
