...
$seo_title = Yii::t('SEO', 'staticpage.title.'.$list->alias);
$seo_description = Yii::t('SEO', 'staticpage.description.'.$list->alias);
$seo_keywords = Yii::t('SEO','staticpage.keywords.'.$list->alias);
