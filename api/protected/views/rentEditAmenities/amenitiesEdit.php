...
<?php $this->widget('ext.widgets.editRentMenuWidget.editRentMenuWidget',array('rentid' => $rent->id,'active' => 'amenities','in_show' => $rent->in_show));?>
			...
			<div class="controller_edit" id="returnform">
				...
				<div class="amenities_box">
					...
					'params' => array(
					    'modelsList' => $amenities,
					    'existArray' => $rentamenityarr,
					    'form' => $form,
					    'view'=>'amenityView'
					    )))
				    ?>
