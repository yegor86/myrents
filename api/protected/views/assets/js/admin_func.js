$(function() {
    $(".flash-alert-error").fadeOut(5000);
    $(".flash-alert-success").fadeOut(5000);
});
function init_odd(){
    $(function(){
...
function ts_makeSortable(table) {
    ...
    for (var i=0;i<firstRow.cells.length;i++) {
        ...
        cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;">'+txt+'<span class="sortarrow">&nbsp;<img src="/img_admin/plus.png" border="0"></span></a>';
    }
...
function ts_resortTable(lnk) {
    ...
    if (span.getAttribute("sortdir") == 'down') {
        ARROW = '&nbsp;<img src="/img_admin/up.png" border="0">';
        newRows.reverse();
        span.setAttribute('sortdir','up');
    } else {
        ARROW = '&nbsp;<img src="/img_admin/down.png" border="0">';
    ...
    for (var ci=0;ci<allspans.length;ci++) {
        if (allspans[ci].className == 'sortarrow') {
            if (getParent(allspans[ci],"table") == getParent(lnk,"table")) {
                allspans[ci].innerHTML = '&nbsp;<img src="/img_admin/plus.png" border="0">';
            }
        }
    }
    remove_odd();
