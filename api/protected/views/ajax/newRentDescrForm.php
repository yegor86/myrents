...
$(document).ready(function($){
    $(".nametextareaz, .nametextareaz2,.nametextareaz3").charCount({allowed: 1000, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
    $(".nametextarea_rulesz, .nametextarea_rulesz2, .nametextarea_rulesz3").charCount({allowed: 480, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
    $(".nameinputz, .nameinputz2, .nameinputz3").charCount({allowed: 130, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
...
<div>
    <?php echo CHtml::textArea('RentDescription['.$key.'][overview]','',array('class'=>'f_form  nametextareaz'.$key.'','rows'=>'8','cols'=>'20','maxlength'=>'1000')); ?>
...
<div>
    <?php echo CHtml::textArea('RentDescription['.$key.'][rules]','',array('class'=>'f_form  nametextarea_rulesz'.$key.'','rows'=>'7','cols'=>'20','maxlength'=>'480')); ?>
