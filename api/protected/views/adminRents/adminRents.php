...
<table border="0" width="100%" cellpadding="1" cellspacing="1" class="sort" id="sort_id">
    <th>ID</th><th>Название</th><th>Дата создания</th><th>Дата ред.</th><th>Статус</th><th>Владелец</th><th>Функции</th>
<?php foreach($rentlist as $rent){ ?>
     <?php if((time() - strtotime($rent->creation_date))< Yii::app()->params['comment_isnew']) { $isnew = 'class="new"'; }else{ $isnew = '' ;}?>
	   <?php $inshow = ($rent->in_show) ? '<span style="color:green">Показано</span>' : '<span style="color:red">Скрыто</span>';  ?>
    <tr>
     ...
     <td width="10%" align="center" <?php echo $isnew?>><?php echo $inshow;?></td>
