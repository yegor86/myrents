...
<a class="search_btn flt_r" onclick="goSearch()" href="javascript:void(0)"></a>
 ...
 <br/>             
        ...
        <div id="home_rent_box" style="z-index: 1;width:523px;">
            ...
            <?php $description = (isset($rent->descriptions[0])) ? $rent->descriptions[0] : RentDescription::model()->findByAttributes(array('rent'=>$rent->id, 'language'=>1));?>
<div>
            
    <div class="image" style="background-image:url(<?php echo (Yii::app()->params['RENTPHOTOSDIR'] . $rent->id .'/' . $rent->photos[0]->file);?>)"></div> 
            <div class="info_rent_user_box">
                <div class="info_rent_user_box-sub">
                    <div class="info_rent_user">
                        <div class="info_rent_user-sub">
                            <a href="/user/<?php echo $rent->renter->id?>" class="avatar" style="background-image: url(<?php echo $photo?>)"></a>

                                <div class="text trans"><b><a href="/rent/<?php echo $rent->id?>"><?php echo $description->name?></a><div class="trans_txt"></div></b>
...
<?php } ?>
    ...
    <div class="clr"></div>
<table border="0" width="70%" id="indexLinks">
    <tr>
        ...
        <td valign="top"><span class="flt_l" style="line-height:21px;"><?php echo Yii::t('default','mr.social')?>:&nbsp;&nbsp;&nbsp;</span>
            ...
            <a class="fancybox fancybox.ajax row" href="/support/"><?php echo Yii::t('default','Support')?></a>
