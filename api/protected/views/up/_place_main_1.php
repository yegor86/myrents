...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td valign="top"><small>Отправте код:</small><span class="numerical" ><?php echo Yii::app()->params['smsbillmainprefix'].Yii::app()->params['smsbillMRprefix'].'+<span id="id_board"></span>'.Yii::app()->params['billingActions'][1].''  ;?></span></td>
