...
<div> <?php echo $form->error($model,'['.$key.']overview'); ?>
    <?php echo $form->textArea($model,'['.$key.']overview',array('class'=>'f_form textarea nametextarea','rows'=>'15','cols'=>'20','maxlength'=>'1000','encode'=>false)); ?>
...
<div> <?php echo $form->error($model,'['.$key.']rules'); ?>
    <?php echo $form->textArea($model,'['.$key.']rules',array('class'=>'f_form textarea nametextarea_rules','rows'=>'7','cols'=>'20','maxlength'=>'480','encode'=>false)); ?>
...
$(document).ready(function($){
    ...
    $(".nametextarea_rules, .nametextarea_rules2, .nametextarea_rules3").charCount({allowed: 480, warning: 50, counterText: " <?php echo Yii::t('default','symbols left')?>"});
