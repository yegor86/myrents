...
<div class="profile_box " style="padding:0;">
 ...
 <?php foreach ($rents as $rent){ 
  ...
  $description =(isset($rent->descriptions[0]))?$rent->descriptions[0] : RentDescription::model()->findByPk(array('rent'=>$rent->id,'language'=>1));
  	 if($rent->cover) $avatar = "/uploads/rentpic/".$rent->id."/thumbs/".$rent->cover->file;
	...
	<div class="price" style="width:500px;float:left;">
		...
		<?php echo CHtml::link('','/rent/'.$rent->id.'/edit',array('class'=>'edit popEdge', 'title'=>Yii::t('default','edit'))) ?>
			  ...
			  <?php echo CHtml::link('','/up/' . $rent->id.'/',array('value'=>$rent->id,'class'=>'upbtn uptop fancybox.ajax row'))?>
