 ...
 *
 * The followings are the available columns in table 'Amenity':
 * @property integer $id
 ...
 * @property Rent[] $rents
 */
class Amenity extends MRActiveRecord {
     ...
     * @return Amenity the static model class
     */
	...
	return array(
	    'rents' => array(self::MANY_MANY, 'Rent', 'AmenityRent(amenity, rent)'),
	);
    }
