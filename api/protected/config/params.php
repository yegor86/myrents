...
//параметры поиска и вывода на страницу
    ...
    'isnew' => 604800, //время, в течении которого объявление считается новым (в секундах), установлено в неделю
...
//переменные для сео-страниц
    'freeUpsByDay'=>66,//количество бесплатных апов в день
    'needCapcha'=>true,
    'seoLinksparam'=>array(
	0=>'CityesUrl',
	2=>'TodoUrl',
...
//  'yandexKey'=>'AA-PyE8BAAAACrsIDwMA9uvpCsK0u0PsIzx-etx3HjB4WloAAAAAAAAAAABDhRBH0fBGvXJqUiElyZrCPLZaSA=='
    ...
    'smsTopPeriods'=>array(
	'4540'=>array('name'=>'top.per.day','price'=>'5.00 грн.','periodInDays'=>3),
	'4126'=>array('name'=>'top.per.three.day','number'=>'333','price'=>'9.00 грн.','periodInDays'=>7),
	'4449'=>array('name'=>'top.per.seven.day','number'=>'777','price'=>'16.00 грн.','periodInDays'=>14),
	),
   'smsMainPeriods'=>array(
	'4540'=>array('name'=>'main.per.day','price'=>'5.00 грн.','periodInDays'=>3),
	'4126'=>array('name'=>'main.per.three.day','number'=>'333','price'=>'9.00 грн.','periodInDays'=>7),
